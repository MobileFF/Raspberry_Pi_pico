...
volatile unsigned int trackNo = 0;
...
void vgmplay() {
    ...
    switch (command) {
        case 0xA0:
            ...
            addr = getByte();
            data = getByte();
//            Serial.print("AY_3_8910.write(");
//            Serial.print(data,HEX);
//            Serial.println(")");
            AY_3_8910.write(addr,data);
            break;
        case 0x61:
            pause(read16());
            break;
...
void loop() {
    ...
    for(int trackNo=0;trackNo<numOfTracks;trackNo++) {
...
//      Serial.println("VGM end.AY_3_8910 reset.");
//      onload=false;
//      vgmend=false;
//      vgmpos = 0xb0;
//      vgmidx = 0;
